...
const api_post_method = function (url, data, config, succesCallback, apiErrorCallback = console.log, otherErrorCallback = console.log) {
...
const api_get_method = function (url, data, config, succesCallback, apiErrorCallback = console.log, otherErrorCallback = console.log) {
    console.log("Run api_post_method")
    if (data) {
        if (!config) {
            config = {}
