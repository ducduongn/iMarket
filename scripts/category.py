...
def recur_buid_cate_tree(o, parents, children):
    ...
    add_to[catid] = {
        "name": name,
        "parent": None if is_p else o['category']['parent_category_detail']['catid']
    }
    if not is_p:
...
# parents = {13079: {'name': 'network devices', 'parent': None}, 13069: {'name': 'pc components', 'parent': None}, 13081: {'name': 'printer, scanner & projector', 'parent': None}, 13083: {'name': 'usb & portable hard drives', 'parent': None}, 14318: {
#     'name': 'gadgets', 'parent': None}, 13077: {'name': 'mice and keyboards', 'parent': None}, 16671: {'name': 'audio & video accessories', 'parent': None}, 13065: {'name': 'laptop', 'parent': None}, 13067: {'name': 'desktop', 'parent': None}}
# children = {13116: {'name': 'wifi repeater', 'parent': 13079}, 13121: {'name': 'others 13079', 'parent': 13079}, 13115: {'name': 'wifi routers', 'parent': 13079}, 13119: {'name': '3g/4g routers', 'parent': 13079}, 13120: {'name': 'computer\xa0networking\xa0switches', 'parent': 13079}, 13117: {'name': 'wifi receivers', 'parent': 13079}, 13415: {'name': 'default 13079', 'parent': 13079}, 13118: {'name': 'usb 3g', 'parent': 13079}, 13104: {'name': 'computer cables & interconnects', 'parent': 13069}, 13126: {'name': 'printer, scanner & projector accessories', 'parent': 13081}, 13123: {'name': 'printer', 'parent': 13081}, 13125: {'name': 'printer ink', 'parent': 13081}, 13127: {'name': 'others 13081', 'parent': 13081}, 13124: {'name': 'projector', 'parent': 13081}, 13417: {'name': 'default 13081', 'parent': 13081}, 13122: {'name': 'scanner', 'parent': 13081}, 13135: {'name': 'external hard drives', 'parent': 13083}, 13131: {'name': 'usb hub', 'parent': 13083}, 13133: {'name': 'internal solid state drives', 'parent': 13083}, 13129: {'name': 'usb 2.0', 'parent': 13083}, 13136: {'name': 'others 13083', 'parent': 13083}, 13134: {'name': 'internal hard drives (hdd)', 'parent': 13083}, 13132: {'name': 'usb otg', 'parent': 13083}, 13130: {'name': 'usb 3.0/3.1', 'parent': 13083}, 13105: {'name': 'others 13069', 'parent': 13069}, 13103: {'name': 'laptop battery & charges', 'parent': 13069}, 13100: {'name': 'fan & cooling', 'parent': 13069}, 14319: {'name': 'default 14318', 'parent': 14318}, 13106: {'name': 'wire keyboards', 'parent': 13077}, 16703: {'name': 'computer speakers', 'parent': 16671}, 16687: {
#     'name': 'webcams', 'parent': 16671}, 16707: {'name': 'computer sound accessories', 'parent': 16671}, 16706: {'name': 'computer headsets', 'parent': 16671}, 16672: {'name': 'default 16671', 'parent': 16671}, 16691: {'name': 'video conference', 'parent': 16671}, 18678: {'name': 'gaming audio', 'parent': 16671}, 13111: {'name': 'wired keyboard & mouse combos', 'parent': 13077}, 13110: {'name': 'mousepad', 'parent': 13077}, 13091: {'name': 'used laptop', 'parent': 13065}, 13087: {'name': 'traditional laptop', 'parent': 13065}, 13089: {'name': 'macbook', 'parent': 13065}, 13090: {'name': 'gaming laptop', 'parent': 13065}, 13066: {'name': 'default 13065', 'parent': 13065}, 13088: {'name': '2 in 1 laptop', 'parent': 13065}, 13094: {'name': 'monitors', 'parent': 13067}, 13093: {'name': 'cpu', 'parent': 13067}, 13092: {'name': 'desktop', 'parent': 13067}, 13068: {'name': 'default 13067', 'parent': 13067}, 13095: {'name': 'all-in-one desktop', 'parent': 13067}, 13096: {'name': 'motherboards', 'parent': 13069}, 13098: {'name': 'power supplies', 'parent': 13069}, 13102: {'name': 'case', 'parent': 13069}, 13101: {'name': 'ram', 'parent': 13069}, 13099: {'name': 'cpu processors', 'parent': 13069}, 13097: {'name': 'vga card', 'parent': 13069}, 13109: {'name': 'wireless mice', 'parent': 13077}, 13108: {'name': 'wired mice', 'parent': 13077}, 13107: {'name': 'wireless keyboards', 'parent': 13077}, 13904: {'name': 'gaming mice', 'parent': 13077}, 13905: {'name': 'gaming keyboard', 'parent': 13077}, 13416: {'name': 'default 13077', 'parent': 13077}, 13112: {'name': 'wireless keyboard & mouse combos', 'parent': 13077}}
    ...
    if len(arg) > 0:
        if arg[0] == 'json':
            ...
            for k, v in parents.items():
                print(k)
                pc = Category(pk=k, name=v['name'].lower())
                pc.save()
            for k, v in children.items():
                try:
                    c = Category(pk=k, name=v['name'].lower(
                    ), parent=Category.objects.get(pk=v['parent']))
                    c.save()
                except Exception:
                    print(v)
                    raise Exception
